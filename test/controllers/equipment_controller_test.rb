...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post equipment_index_url, params: { equipment: { company_id: @equipment.company_id, name: @equipment.name } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { company_id: @equipment.company_id, name: @equipment.name } }
