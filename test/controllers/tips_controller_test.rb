...
class TipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post tips_url, params: { tip: { company_id: @tip.company_id, fee: @tip.fee, fire_ant_risk_level: @tip.fire_ant_risk_level, name: @tip.name } }
    end
  ...
  test "should update tip" do
    patch tip_url(@tip), params: { tip: { company_id: @tip.company_id, fee: @tip.fee, fire_ant_risk_level: @tip.fire_ant_risk_level, name: @tip.name } }
