...
class AddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update address" do
    patch address_url(@address), params: { address: { addressable_id: @address.addressable_id, addressable_type: @address.addressable_type, city: @address.city, latitude: @address.latitude, longitude: @address.longitude, map_reference: @address.map_reference, po_box: @address.po_box, state: @address.state, street_address: @address.street_address } }
